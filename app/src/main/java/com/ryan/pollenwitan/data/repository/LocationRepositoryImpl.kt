...
class LocationRepositoryImpl(
    ...
    override fun getLocation(): Flow<AppLocation> = dataStore.data.map { prefs ->
    ...
    override fun getLocationMode(): Flow<LocationMode> = dataStore.data.map { prefs ->
        LocationMode.valueOf(prefs[Keys.MODE] ?: LocationMode.Manual.name)
    }

    override suspend fun setManualLocation(latitude: Double, longitude: Double, displayName: String) {
    ...
    override suspend fun updateGpsLocation(latitude: Double, longitude: Double, displayName: String) {
        dataStore.edit { prefs ->
