...
import com.ryan.pollenwitan.data.local.CachedForecastDao
...
class AirQualityRepositoryImpl(
    ...
    private val dao: CachedForecastDao
    ...
    companion object {
        ...
        private const val CACHE_CLEANUP_AGE_MS = 24 * 60 * 60 * 1000L  // 24 hours
    }
}
